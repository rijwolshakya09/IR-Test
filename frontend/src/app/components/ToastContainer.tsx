...
function Toast({ toast }: { toast: ToastType }) {
  ...
  return (
    <div
      className={`
        flex items-center p-4 rounded-lg shadow-lg border-l-4 min-w-[300px] max-w-md
    ...
    >
      ...
      <button onClick={() => removeToast(toast.id)} className="ml-3 flex-shrink-0 hover:opacity-70 transition-opacity">
